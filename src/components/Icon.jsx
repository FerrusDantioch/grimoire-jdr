/**
 * Jeu d'icones inline : pas de requete reseau, colorees par `currentColor`,
 * donc utilisables hors ligne et compatibles avec les deux themes.
 */
const PATHS = {
  ...
  dice: 'M12 2 3 7v10l9 5 9-5V7l-9-5ZM12 22V12M3 7l9 5 9-5',
  ...
  edit3: 'M12 20h9M16.5 3.5a2.12 2.12 0 0 1 3 3L7 19l-4 1 1-4Z',
...
// Une taille intrinseque est indispensable : sans elle, un SVG place
// hors d'un conteneur qui le dimensionne s'etire a toute la place disponible.
